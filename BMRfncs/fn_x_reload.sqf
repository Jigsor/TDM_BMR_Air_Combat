// Code by Zeno
// _xhandle= (objectparent player) spawn BMR_AC_fnc_x_reload;
if (missionNameSpace getVariable ["BMRserviceInProgress", false]) exitWith {};
missionNameSpace setVariable ["BMRserviceInProgress", true];
private _object = _this;
private _type = typeOf _object;

[_object] call BMR_AC_fnc_healCrew;

x_reload_time_factor = 0.2;
...
if (_type in BMR_add_Chaff) then {_object addweapon "CMFlareLauncher"; _object addmagazine "120Rnd_CMFlare_Chaff_Magazine";};
sleep x_reload_time_factor;
_object vehicleChat format ["%1 is ready...", _type];
missionNameSpace setVariable ["BMRserviceInProgress", false];