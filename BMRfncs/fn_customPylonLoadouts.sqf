...
//RHS
	case "RHSGREF_A29B_HIDF" : {_pylons=["rhs_mag_M151_7_USAF_LAU131","rhs_mag_FFAR_7_USAF","","rhs_mag_FFAR_7_USAF","rhs_mag_M151_7_USAF_LAU131","rhsusf_ANALE40_CMFlare_Chaff_Magazine_x2"]};
