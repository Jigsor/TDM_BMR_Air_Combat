//Edit these 2 lists below to not allow certain air vehicles. Typically these do not have appropriate driver weapons.
...
//Sab Military Aviation
	// "Sab_an22_2","Sab_an22_3","sab_c160_b","sab_c2a_1","sab_c2a_1_1","sab_c2a_1_2","sab_pc7_c","sab_pc9_b" <-- these get filtered automatically
	"Sab_an12_5",
	"Sab_an12_7"
];
...
if (call BMR_AC_fnc_isWWII) then {
